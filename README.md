...
*   **Alineación de Cobertura Sonar/JaCoCo**: Las exclusiones de cobertura de SonarQube (`sonar.coverage.exclusions`) deben mantenerse sincronizadas con las exclusiones de JaCoCo para evitar discrepancias en el porcentaje reportado.
